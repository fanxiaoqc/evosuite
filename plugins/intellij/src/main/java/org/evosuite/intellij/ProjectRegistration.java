...
// the plugin.xml file, this method is called on IDEA start-up.
    ...
    public void projectOpened() {
        ...
        ToolWindow toolWindow = toolWindowManager.registerToolWindow("NUT Hammer", false, ToolWindowAnchor.BOTTOM);
        toolWindow.setTitle("NUT Hammer Console Output");
        ...
        IntelliJNotifier notifier = IntelliJNotifier.registerNotifier(project,"NUT Hammer Plugin", console);
        ...
        ActionToolbar viewToolbar = am.createActionToolbar("NUT Hammer.ConsoleToolbar", buttonGroup, false);
