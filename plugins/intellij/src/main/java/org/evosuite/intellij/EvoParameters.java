...
public class EvoParameters {
    ...
    public void load(Project project){
        ...
        cores = Integer.parseInt(p.getValue(CORES_EVOSUITE_PARAM,"1"));
        memory = Integer.parseInt(p.getValue(MEMORY_EVOSUITE_PARAM,"2000"));
        time = Integer.parseInt(p.getValue(TIME_EVOSUITE_PARAM,"3"));
        //modify by me
        ...
        guiWidth = Integer.parseInt(p.getValue(GUI_DIALOG_WIDTH, "570"));
        guiHeight = Integer.parseInt(p.getValue(GUI_DIALOG_HEIGHT, "450"));
    }
